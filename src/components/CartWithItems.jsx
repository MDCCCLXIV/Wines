        ...
        <div className="flex justify-between h-full w-full mx-auto p-2">
          ...
          <div className="flex flex-col w-[23%] h-[60%] border rounded-md  ">
            ...
            <div className="flex flex-col m-1 ">
              <button className='bg-red-500 w-full text-lg border rounded-lg p-2 text-white hover:bg-red-700'>Checkout KES {subtotal + deliveryfee}.oo</button>
            </div>
